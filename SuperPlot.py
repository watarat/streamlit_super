...
#----------------------------------------------------------------
    data_melted = pd.melt(maindataframe, id_vars=[column], value_vars=domain, var_name='variable', value_name='value')
    data_melted_tick = pd.melt(tickdataframe, id_vars=[column], value_vars=tickfield, var_name='variablet', value_name='valuet')
    match column :
        case 'RFS AGE' :
            xcolor = '#00ff00' #green'
...
#----------------------------------------------------------------
    ...
    gap, col1, col2, col3, col4 = st.columns([1, 2, 2, 3, 7])
    MarkButton = col1.button('Mark This')
    ClearButton = col2.button('Clear Mark')
